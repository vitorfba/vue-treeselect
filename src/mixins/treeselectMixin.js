    ...
    handleRemoteSearch() {
      ...
      this.callLoadOptionsProp({
        ...
        start: () => {
          ...
          entry.loadingError = ''
          // Sincronizar com rootOptionsStates para garantir reatividade no Vue 3
          this.rootOptionsStates.isLoading = true
          this.rootOptionsStates.isLoaded = false
          this.rootOptionsStates.loadingError = ''
        },
        succeed: options => {
          entry.isLoaded = true
          entry.options = Array.isArray(options) ? options : (options || [])
          // Sincronizar com rootOptionsStates
